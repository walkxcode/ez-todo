...
const Sidebar = (props: DrawerContentComponentProps) => {
	...
	const handlePressMenuHowto = useCallback(
		() => {
	...
	return (
		<AnimatedColorBox safeArea flex={1} bg={useColorModeValue('purple.50', 'purple.800')} p={7}>
			<VStack flex={1} space={2}>
				<HStack justifyContent="flex-end">
					<IconButton
						...
						_icon={{
							...
							name: 'chevron-left',
							size: 6,
							color: useColorModeValue('purple.800', 'purple.700')
						}}
					/>
				</HStack>
				<Avatar
				...
				<MenuButton active={currentRoute === 'Howto'} onPress={handlePressMenuHowto} icon="help-circle">
					How to use?
				</MenuButton>
			</VStack>
			<Center>
